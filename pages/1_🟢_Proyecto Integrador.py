...
tad_descripcion, tab_Generador, tab_datos, tab_Análisis_Exploratorio, tab_Filtrado_Básico, tab_Filtro_Final_Dinámico = st.tabs(["Descripción", "Datos", "Análisis Exploratorio", "Filtrado Básico", "Filtro Final Dinámico"])
